...
class Widget_Eael_Team_Member extends Widget_Base {
   ...
   public function get_categories() {
	...
	protected function _register_controls() {
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ '%', 'px' ],
				'selectors' => [
					'{{WRAPPER}} .eael-team-item figure img' => 'max-width:{{SIZE}}{{UNIT}};',
				],
				'condition' => [
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .eael-team-member-social-link > a' => 'font-size: {{SIZE}}{{UNIT}};',
				],
			]
		);

		$this->add_control(
			'eael_team_members_social_icon_spacing',
			[
				...
				'selectors' => [
					'{{WRAPPER}} .eael-team-member-social-link > a' => 'width: {{SIZE}}{{UNIT}};',
				],
			]
		);
	...
	protected function render_team_member_image() {
	...
	<div id="eael-team-member-<?php echo esc_attr($this->get_id()); ?>" class="eael-team-item <?php echo $team_member_classes; ?>">
		<div class="eael-team-item-inner">
			...
			<div class="eael-team-image">
				<figure>
					<?php $this->render_team_member_image(); ?>
				</figure>
			</div>
			<?php endif; ?>
