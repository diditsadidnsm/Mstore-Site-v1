...
class Widget_Eael_Progress_Bar extends Widget_Base {
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'options'              => [
                    ...
                    'energy'       => __( 'Energy', 'essential-addons-elementor' ),
                    'stripe'       => __( 'Stripe', 'essential-addons-elementor' ),
        ...
        $this->add_responsive_control(
			...
			[
				'label' => __( 'Progressbar Alignment', 'essential-addons-elementor' ),
				'type' => Controls_Manager::CHOOSE,
				'options' => [
					'left' => [
    ...
    protected function render() {
        ...
        $this->add_render_attribute( 'eael-progress-bar-container', 'class', 'eael-progress-bar-container' );
        $this->add_render_attribute( 'eael-progress-bar-container', 'class', $settings['progress_bar_alignment'] );
        $this->add_render_attribute( 'eael-progress-bar-container', 'data-layout', $settings['progress_bar_layout'] );
        $this->add_render_attribute( 'eael-progress-bar-container', 'data-id', esc_attr($this->get_id()) );
        $this->add_render_attribute( 'eael-progress-bar-container', 'data-number', $settings['progress_number'] );
        ...
        if('fan' == $settings['progress_bar_layout'] or 'circle' == $settings['progress_bar_layout'] or 'bubble' == $settings['progress_bar_layout']) {
            $class = 'label-center';
            $height = '150px';
        }elseif('text' == $settings['progress_bar_layout']){
            $height = '50px';
        }else {
            $class = '';
            $height = '30px';
        ...
        ?>
            ...
            <div <?php echo $this->get_render_attribute_string( 'eael-progress-bar-container' ); ?>>
                <?php if (  'yes' == $settings['progress_bar_show_title'] ) : ?><div class="progress-title"><?php printf( '<%1$s>', $settings['title_html_tag'] ); echo $settings['progress_bar_title']; printf( '</%1$s>', $settings['title_html_tag'] ); ?>
                </div><?php endif; ?>
                <div 
                    style="height: <?php echo $height;?>" 
                    class="ldBar auto <?php echo $class;?>" 
                    data-preset="<?php echo $settings['progress_bar_layout']; ?>" 
                    id="myItem<?php echo esc_attr($this->get_id()); ?>">
                </div>
