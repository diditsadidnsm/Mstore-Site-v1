	...
	<div class="wrap about-wrap pagebuilderly-add-css">
		<div>
			...
			<div class="feature-section three-col">
				...
				<div class="col">
					<div class="widgets-holder-wrap">
						<h3><?php echo esc_html__("Review PageBuilderly", "pagebuilderly"); ?></h3>
						<p><?php echo esc_html__("Nothing motivates us more than feedback, are you are enjoying PageBuilderly? We would love to hear what you think!", "pagebuilderly"); ?></p>
						<p><a target="blank" href="<?php echo esc_url('https://wordpress.org/support/theme/pagebuilderly/reviews/?filter=5', 'pagebuilderly'); ?>" class="button button-primary">
		...
		<table class="wp-list-table widefat">
			...
			<tbody>
				...
				<tr>
					<td><?php echo esc_html__("Fully SEO Optimized", "pagebuilderly"); ?></td>
					<td><span class="cross"><img src="<?php echo esc_url( get_template_directory_uri() . '/icons/cross.png' ); ?>" alt="<?php echo esc_html__("No", "pagebuilderly"); ?>" /></span></td>
					<td><span class="checkmark"><img src="<?php echo esc_url( get_template_directory_uri() . '/icons/check.png' ); ?>" alt="<?php echo esc_html__("Yes", "pagebuilderly"); ?>" /></span></td>
				</tr>
				<tr>
					<td><?php echo esc_html__("0.2 Seconds Load Time", "pagebuilderly"); ?></td>
					<td><span class="cross"><img src="<?php echo esc_url( get_template_directory_uri() . '/icons/cross.png' ); ?>" alt="<?php echo esc_html__("No", "pagebuilderly"); ?>" /></span></td>
					<td><span class="checkmark"><img src="<?php echo esc_url( get_template_directory_uri() . '/icons/check.png' ); ?>" alt="<?php echo esc_html__("Yes", "pagebuilderly"); ?>" /></span></td>
				</tr>
				<tr>
				...
				<tr>
					<td><?php echo esc_html__("Access All Child Themes	", "pagebuilderly"); ?></td>
					<td><span class="cross"><img src="<?php echo esc_url( get_template_directory_uri() . '/icons/cross.png' ); ?>" alt="<?php echo esc_html__("No", "pagebuilderly"); ?>" /></span></td>
					<td><span class="checkmark"><img src="<?php echo esc_url( get_template_directory_uri() . '/icons/check.png' ); ?>" alt="<?php echo esc_html__("Yes", "pagebuilderly"); ?>" /></span></td>
				</tr>
				<tr>
					<td><?php echo esc_html__("Importable Demo Content	", "pagebuilderly"); ?></td>
					<td><span class="cross"><img src="<?php echo esc_url( get_template_directory_uri() . '/icons/cross.png' ); ?>" alt="<?php echo esc_html__("No", "pagebuilderly"); ?>" /></span></td>
					<td><span class="checkmark"><img src="<?php echo esc_url( get_template_directory_uri() . '/icons/check.png' ); ?>" alt="<?php echo esc_html__("Yes", "pagebuilderly"); ?>" /></span></td>
				</tr>
			</tbody>
		...
		<div class="pagebuilderly-button-container">
			<a target="blank" href="<?php echo esc_url('https://superbthemes.com/pagebuilderly/', 'pagebuilderly'); ?>" class="button button-primary">
				<?php echo esc_html__("GO PREMIUM", "pagebuilderly"); ?>
			</a>
		</div>
	</div>
	<?php
