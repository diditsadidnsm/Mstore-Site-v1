...
<div class="site-info">
	<div class="container">
		...
		<!-- Delete below lines to remove copyright from footer -->
			...
			<?php echo esc_html__(' | WordPress Theme Design by', 'pagebuilderly') ?> <a href="<?php echo esc_url('https://superbthemes.com/', 'pagebuilderly'); ?>"><?php echo esc_html__('Superb', 'pagebuilderly') ?></a>
			</span>
