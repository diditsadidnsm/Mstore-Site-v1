					    	...
					    	<section id="post_section">
								...
								while ( have_posts() ) : the_post();
									...
									the_post_navigation( array(
										'prev_text' => '<span class="screen-reader-text">' . __( 'Previous Post', 'lz-computer-repair' ) . '</span><span aria-hidden="true" class="nav-subtitle">' . __( 'Previous', 'lz-computer-repair' ) . '</span>',
										'next_text' => '<span class="screen-reader-text">' . __( 'Next Post', 'lz-computer-repair' ) . '</span><span aria-hidden="true" class="nav-subtitle">' . __( 'Next', 'lz-computer-repair' ) . '</span> ',
									) );
